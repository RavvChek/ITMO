...
<html>
  ...
  <body style="font-family: Arial, sans-serif; margin: 2rem;">
    ...
    <div style="background-color: #f5f5f5; padding: 1rem; border-radius: 5px; margin-top: 1rem;">
      <p style="margin: 0.5rem 0;"><strong>Статус Redis:</strong> {{ redis_status }}</p>
      <p style="margin: 0.5rem 0;"><strong>Хост Redis:</strong> {{ redis_host }}:{{ redis_port }}</p>
    </div>
  </body>
</html>
"""
...
if __name__ == "__main__":
    app.logger.info(f"Container name: {CONTAINER_NAME}")
